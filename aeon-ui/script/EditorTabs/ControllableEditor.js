...
let ControllableEditor = {
  ...
  init() {
    this._table = new TableWidget(
      document
        .getElementById("controllable-editor-table")
        .getElementsByTagName("tbody")[0],
      document.getElementById("controllable-editor-filter"),
    );
    this._counters = {
      true: new CountWidget(document.getElementById("controllable-count"), 0),
      false: new CountWidget(
        document.getElementById("uncontrollable-count"),
        0,
      ),
    };
  },
  ...
  addVariable(variable) {
    ...
    this._updateCounts();
    this._table.changeIndicatorColor(
      variable.id,
      variable.controllable == true ? "#FFFF66" : "#B0BEC5",
    );
