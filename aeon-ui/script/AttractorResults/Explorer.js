let Explorer = {
  ...
  openNewExplorer(behaviorData) {
    ...
    if (behavior != null) {
      ...
      if (variable === null || vector === null) {
        ComputeEngine._backendRequest(
          "/get_tree_attractors/" + treeWitness,
          callback,
          "GET",
          null,
        );
  ...
  _nodeClick(e) {
    ...
    document.getElementById("explorer-valuations-text").innerHTML =
      Explorer._stateToHtml(e.nodes[0]);
  },
  ...
  witnessPanelVisible(show = true) {
    document.getElementById("explorer-witness-panel").style.display = show
      ? "block"
      : "none";
  },
